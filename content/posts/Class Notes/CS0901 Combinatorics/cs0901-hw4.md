...
![](/images/cs0901-hw4/pasted-image-20251019112205.png)

考虑这样一个图，最长路径长度为 {{< imath >}}9{{< /imath >}}，并且总共 {{< imath >}}12{{< /imath >}} 个顶点，任意去掉一个点，都还存在经过 {{< imath >}}10{{< /imath >}} 个点的最长路径，符合我们的构造，这就得到了一个反例。