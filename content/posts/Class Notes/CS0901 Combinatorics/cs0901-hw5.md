...
其中最大独立集大小为 {{< imath >}}5{{< /imath >}}，取外圈的一层点，但是 {{< imath >}}\chi(G)=5{{< /imath >}}，最大独立集中每个点都被染上了不同的颜色，与题设矛盾。

![200](/images/cs0901-hw5/pasted-image-20251026085311.png)

构造思路：先用中间的团来限制染色数为 {{< imath >}}5{{< /imath >}}，接着再向外拓展其他的点，保证这些点构成独立集，并且颜色被限定只能与对面的点相同。
